...
function getRandomValueWithRanges(array) {
...
function generateRandomBusiness() {
  return getRandomValueWithRanges(businessRanges);
}

function generateRandomBuildingDamage() {
  return getRandomValueWithRanges(buildingDamageRanges);
}
...
function generateRandomJob() {
  return getRandomValueWithRanges(jobRanges);
}

function generateRandomCrisis() {
  let randomVal = getRandomValueWithRanges(crisisOptions);
  if (randomVal === "Roll Again Twice") {
    let crisisOne, crisisTwo;
    do {
      crisisOne = getRandomValueWithRanges(crisisOptions);
    } while (crisisOne === "Roll Again Twice");

    do {
      crisisTwo = getRandomValueWithRanges(crisisOptions);
...
function generateRandomNPC() {
  ...
  let name =
    gender === "M"
      ? pickRandomValue(maleNames) + " " + pickRandomValue(lastNames)
      : pickRandomValue(femaleNames) + " " + pickRandomValue(lastNames);
